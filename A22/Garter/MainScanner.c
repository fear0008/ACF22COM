...
/* External objects */
extern gar_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
gar_void printScannerError(gar_char* fmt, ...);
gar_void displayScanner(BufferReader* ptrBuffer);
gar_long getScannerFilesize(gar_char* fname);
...
gar_intg mainScanner(gar_intg argc, gar_char** argv) {
